...
PKGS_MYSQL="mariadb mariadb-client pwgen mariadb-dev"
PKGS_NGINX="nginx"
...
PIP_MODULES="MySQL-python==1.2.5 web.py==0.40 sqlalchemy==1.3.13 dnspython==1.16.0 requests==2.23.0 netifaces==0.10.9"
