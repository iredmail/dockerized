...
# Update parameters.
${CMD_PERL} "s#PH_HOSTNAME#${HOSTNAME}#g" ${AMAVISD_CONF}
${CMD_PERL} "s#PH_FIRST_MAIL_DOMAIN#${FIRST_MAIL_DOMAIN}#g" ${AMAVISD_CONF}

${CMD_PERL} "s#PH_SQL_SERVER_ADDRESS#${SQL_SERVER_ADDRESS}#g" ${AMAVISD_CONF} ${SPAMASSASSIN_CONF_LOCAL}
${CMD_PERL} "s#PH_SQL_SERVER_PORT#${SQL_SERVER_PORT}#g" ${AMAVISD_CONF} ${SPAMASSASSIN_CONF_LOCAL}

${CMD_PERL} "s#PH_AMAVISD_DB_PASSWORD#${AMAVISD_DB_PASSWORD}#g" ${AMAVISD_CONF}

${CMD_PERL} "s#PH_SA_BAYES_DB_PASSWORD#${SA_BAYES_DB_PASSWORD}#g" ${SPAMASSASSIN_CONF_LOCAL}
